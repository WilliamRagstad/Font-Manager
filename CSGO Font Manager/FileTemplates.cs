...
namespace CSGO_Font_Manager
{
    class FileTemplates
    {
        public static string fonts_conf(string fontname, string fontext, string fontfile) =>
            "<?xml version='1.0'?>\n" +
        ...
        public static string fonts_conf_backup(string fontname, string fontext, string fontfile) =>
            "<?xml version='1.0'?>\n" +
            "<!DOCTYPE fontconfig SYSTEM 'fonts.dtd'>\n" +
            "<fontconfig>\n" +
            "\n" +
            ...
            "	\n" +
            "	<!-- Custom fonts -->\n" +
            "	<!-- Edit every \"" + fontname + "\" occurency with your font name (NOT the font file name) -->\n" +
            "	\n" +
            "	<match>\n" +
            "		<test name=\"family\">\n" +
            "			<string>Stratum2</string>\n" +
